...
Project Work — CdL Informatica per le Aziende Digitali (L-31)
...
1. **Hero** 
2. **Il Gruppo** — profilo aziendale + statistiche animate
3. **Le tre R di Caviro** — Ritirare, Rigenerare, Restituire
4. **Economia circolare** — diagramma di flusso interattivo
5. **Sostenibilità in numeri** 
6. **SDG ONU** — 13 Obiettivi Agenda 2030
...
9. **Footer** — contatti, social, newsletter.
...
- Reveal-on-scroll con effetto a cascata su quasi tutti gli elementi via IntersectionObserver;
...
## Tecnologie
HTML5 semantico, CSS3 (variabili, Grid, Flexbox, animazioni/transizioni, media query), JavaScript.

## Nota sui contenuti
Dati e contenuti tratti da caviro.com a scopo puramente accademico.

## Autore
Daniel Francesco Aurello Matr.0312300302 — Project Work, CdL Informatica per le Aziende Digitali (L-31).